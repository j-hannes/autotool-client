...
import           Utils.Render       (translateScore, translateStatus)
...
renderAssignment assignment = do
    ...
    myBestScore  <- lift $ Model.getBestScoreForStudent assignment student
    I.runChildrenWith [
      ...
      , ("mybestscore",    id |- translateScore myBestScore)
